...
const QString BaiduSpeechClientID = "agxGPLACcXAPk9OoBmhrBHVI";     /**< 百度云API Key*/
const QString BauduSpeechClientSecret = "paDXxXbGRlL7BUcT6ughBq1bppiLaP1G";/**< 百度云Secret Key*/
const  QString BaiduSpeechSatrtUrl = "https://vop.baidu.com/server_api?dev_pid=1537&cuid=%1&token=%2";/**< 识别普通话 本机唯一标识 获取的token*/
