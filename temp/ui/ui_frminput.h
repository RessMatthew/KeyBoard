...
public:
    ...
    void setupUi(QWidget *frmInput)
    {
        ...
        gridLayout->addWidget(btnx, 3, 4, 1, 1);
        ...
        gridLayout->addWidget(btnOther17, 3, 10, 1, 1);
        ...
        gridLayout->addWidget(btn6, 2, 18, 1, 1);
        ...
        sizePolicy4.setHeightForWidth(btnz_ctrl_3->sizePolicy().hasHeightForWidth());
        btnz_ctrl_3->setSizePolicy(sizePolicy4);
        ...
        sizePolicy4.setHeightForWidth(btnz_alt_3->sizePolicy().hasHeightForWidth());
        btnz_alt_3->setSizePolicy(sizePolicy4);
        btnz_alt_3->setFocusPolicy(Qt::NoFocus);

        gridLayout->addWidget(btnz_alt_3, 4, 12, 1, 1);

        btnz_win = new QPushButton(widgetMain);
        btnz_win->setObjectName(QStringLiteral("btnz_win"));
        sizePolicy4.setHeightForWidth(btnz_win->sizePolicy().hasHeightForWidth());
        btnz_win->setSizePolicy(sizePolicy4);
        btnz_win->setFocusPolicy(Qt::NoFocus);
        ...
        gridLayout->addWidget(btn2, 3, 17, 1, 1);
        ...
        btnz_ctrl2->setSizePolicy(sizePolicy4);
        btnz_ctrl2->setFocusPolicy(Qt::NoFocus);
        ...
        gridLayout->addWidget(btnh, 2, 7, 1, 1);
        ...
        gridLayout->addWidget(btnd, 2, 4, 1, 1);
        ...
        gridLayout->addWidget(btnj, 2, 8, 1, 1);
        ...
        sizePolicy4.setHeightForWidth(btnz_Num->sizePolicy().hasHeightForWidth());
        btnz_Num->setSizePolicy(sizePolicy4);
        btnz_Num->setFocusPolicy(Qt::NoFocus);
        ...
        btnOther12_3->setSizePolicy(sizePolicy4);
        btnOther12_3->setFocusPolicy(Qt::NoFocus);
